...
- when upgrading your installed [monorepo](https://docs.shopsys.com/en/8.1/introduction/monorepo/), you'll have to change the build context for the images of the microservices in `docker-compose.yml`
...
[From v8.1.1 to v9.0.0-dev]: https://github.com/shopsys/shopsys/compare/v8.1.1...master
